<x-template showHeader="true">
    <div class="relative sm:flex sm:justify-center sm:items-center selection:bg-red-500 selection:text-white"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="p-4 m-10">
                <input type="text" id="myInput" placeholder="Cliquez pour localiser" style="cursor: pointer;"
                    class="text-center text-white bg-gray-800 min-w-[250px] p-2 border rounded-l-lg w-1/2" readonly
                    required>
            </div>
            <div style="display: flex; justify-content:space-between;">
                <div style="cursor: pointer; color: white; background-color: rgba(38, 38, 38, 1); border: solid 1px white; padding: 6px 12px; border-radius: 50px;"
                    onclick="goToEvents()" id="toEvent">Evénements</div>
                <div style="cursor: pointer; color: white; background-color: rgba(38, 38, 38, 1); border: solid 1px white; padding: 6px 12px; border-radius: 50px;"
                    onclick="goToArtists()" id="toArtists">Artistes</div>
            </div>
            <script>
                function goToEvents() {
