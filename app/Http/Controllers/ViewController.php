...
class ViewController extends Controller
{
    ...
    public function filters(): View
    {
        ...
        return view('filters', [
            'musicStyle' => ["Rock", "Electro", "Pop", "Jazz", "Hip-Hop", "Japan", "Electropop", "Techno", "Ambient", "Classique", "Punk", "Metal", "Pop Rock", "Folk", "Country", "House", "Hard-Rock", "Soul", "RnB", "Reggae", "Blues", "Disco", "Indie", "Soundtrack", "Heavy Metal", "Experimental", "Pop/Rock", "Alternative", "Rap", "Score", "Hardcore", "Lo-Fi", "Pop Punk", "Country Rock", "Punk Rock", "Drum and Bass", "Jazz Fusion", "Horror Punk", "Christmas", "Goth Rock", "Acoustic", "Electro-Acoustic" ],
